...
* **Ctrl+S** – select multiple particles or springs with a rectangle. When several objects are selected a SelectionMenu popup lets you pick one to inspect
...
* **0** – adjust environment settings (temperature, gravity, repulsion, damping, collisions and particle trails)
