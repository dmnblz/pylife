...
* **Channel signalling** – Sensors and variable elements can share integer channels; triggering a sensor toggles all variable particles, springs and bends assigned to its channel.
