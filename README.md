...
* **Modular codebase** – the core simulation is split into small modules:
  ...
  * `sensor.py` – circular or sector sensors that invoke callbacks when
    tagged objects enter their view.
