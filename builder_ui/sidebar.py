...
class SidebarUI:
    ...
    def _setup_ui(self):
        ...
        add_button("VarPar", lambda: self.app.set_mode("vparticle"), "Ctrl+2", "vparticle")
        add_button("Spring", lambda: self.app.set_mode("spring"), "3", "spring")
        add_button("VarSpr", lambda: self.app.set_mode("vspring"), "Ctrl+3", "vspring")
        add_button("Bend", lambda: self.app.set_mode("bend"), "4", "bend")
        add_button("VarBend", lambda: self.app.set_mode("vbend"), "Ctrl+4", "vbend")
        ...
        add_button("Inspect", lambda: self.app.set_mode("inspect"), "8 / Ctrl+I", "inspect")
        add_button("Events", self.app.open_events_modal, "Ctrl+E", None)
        add_button("Grid", lambda: self.app.set_mode("grid"), "9 / Ctrl+G", "grid")
